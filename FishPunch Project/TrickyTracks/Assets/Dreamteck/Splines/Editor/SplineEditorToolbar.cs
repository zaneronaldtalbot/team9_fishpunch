...
namespace Dreamteck.Splines
{
    public class LayermaskWindow : EditorWindow
    {
        ...
        internal void Init(SplineEditor e)
        {
            editor = e;
            minSize = maxSize = new Vector2(150, 30);
#if UNITY_5_0
            title = "Layermask";
#else 
            titleContent = new GUIContent("Layermask");
#endif
        }
        ...
        private void OnGUI()
        {
            ...
            {
                if (((1 << layerNumbers[i]) & editor.surfaceLayerMask.value) > 0)
            ...
            editor.surfaceLayerMask.value = mask;
        }
    }
    public partial class SplineEditor
    {
        ...
        private string[] operations = new string[] {"Operations", "Center to Transform", "Move Transform to", "Flat X", "Flat Y", "Flat Z", "Mirror X", "Mirror Y", "Mirror Z", "Distribute evenly" };
        ...
        private void Main() {
            ...
            if (SplineEditorGUI.BigButton(new Rect(270 * scale, 5 * scale, 35 * scale, 35 * scale), normalsButtonContent, !computer.is2D, tool == SplineEditor.PointTool.NormalEdit))
            {
        ...
        private void CreateToolbar(int verticalOffset)
        {
            ...
            if (hover) mouseHoversToolbar = true;
            SplineEditorGUI.Label(new Rect(220 * scale, verticalOffset+5 * scale, 100 * scale, 25 * scale), "Normal:", true);
            ...
            if (hover) mouseHoversToolbar = true;
            SplineEditorGUI.Label(new Rect(800 * scale, verticalOffset + 5 * scale, 90 * scale, 25 * scale), "Add Node", true);
            ...
            {
                SplineEditorGUI.Label(new Rect(500 * scale, verticalOffset+5 * scale, 80 * scale, 30 * scale), "Grid offset:", true);
                showNormalField = true;
            } else if(createPointMode == 2){
                SplineEditorGUI.Label(new Rect(480 * scale, verticalOffset + 5 * scale, 100 * scale, 30 * scale), "Normal offset:", true);
                showNormalField = true;
                if(SplineEditorGUI.Button(new Rect(925 * scale, verticalOffset * scale + 5, 95 * scale, 25 * scale), "LayerMask"))
                {
                    ...
                    maskWindow.Init(this);
                }
            } else if (createPointMode == 0)
            {
                SplineEditorGUI.Label(new Rect(500 * scale, verticalOffset + 5 * scale, 80 * scale, 30 * scale), "Far plane:", true);
                showNormalField = true;
            }
            ...
            {
                SplineEditorGUI.Label(new Rect(625 * scale, verticalOffset + 5 * scale, 80 * scale, 30 * scale), "Append:", true);
        ...
        private void Create2DToolbar(int verticalOffset)
        {
            ...
            if (hover) mouseHoversToolbar = true;
            SplineEditorGUI.Label(new Rect(230 * scale, verticalOffset + 5 * scale, 90 * scale, 25 * scale), "Add Node", true);
            ...
            if (createPointMode != 1)
            {
                SplineEditorGUI.Label(new Rect(325 * scale, verticalOffset + 5 * scale, 80 * scale, 30 * scale), "Append:", true);
        ...
        private void Translate(int verticalOffset)
        {
            ...
            GUI.Box(barRect, "", SplineEditorGUI.whiteBox);
            GUI.color = SplineEditorGUI.activeColor;
            SplineEditorGUI.Label(new Rect(110 * scale, verticalOffset + 5 * scale, 90 * scale, 25 * scale), "Grid snap", true);
            ...
            {
                SplineEditorGUI.Label(new Rect(220 * scale, verticalOffset + 5 * scale, 80 * scale, 30 * scale), "Grid size:", true);
        ...
        private void Rotate(int verticalOffset)
        {
            ...
            SplineEditorGUI.Label(new Rect(120 * scale, verticalOffset + 5 * scale, 120 * scale, 25 * scale), "Rotate normals", true);
            ...
            SplineEditorGUI.Label(new Rect(260 * scale, verticalOffset + 5 * scale, 120 * scale, 25 * scale), "Rotate tangents", true);
